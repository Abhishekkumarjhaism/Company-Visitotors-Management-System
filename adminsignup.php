<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="insert into tbladmin(AdminName,UserName,MobileNumber,Email,Password) values('$aname','$user','$mobile','$email','$pass')";
...
<body style="background-image:url('images/icon/g.jpg');background-repeat: no-repeat;background-size: cover">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-6"style="margin-left:25%;background-color:red">
                                <div class="card" style="background-image:url('images/icon/g.jpg')">
                                    <div class="card-header">
                                        <strong>Add</strong> New Admin
                                    </div>
						 ...
						 <div class="row form-group">
                                                ...
                                                <div class="col-6 col-md-9">
                                                    <input type="password" id="fullname" name="password" placeholder="Full Name" class="form-control" required="">
